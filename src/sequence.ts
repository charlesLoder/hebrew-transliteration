 ...
 * @remarks
 * seqeuncing follows the patters of: consonant - dagesh - vowel - ta'am as defined in the {@link https://www.sbl-site.org/Fonts/SBLHebrewUserManual1.5x.pdf | SBL Hebrew Font Manual}
 *
 * @example
 *
 * ```ts
