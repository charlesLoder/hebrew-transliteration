...
- transliteration - <a href={`${import.meta.env.BASE_URL}api/functions/transliterate`}>`transliterate()`</a>
- removing niqqud - <a href={`${import.meta.env.BASE_URL}api/functions/remove`}>`remove()`</a>
- sequencing text - <a href={`${import.meta.env.BASE_URL}api/functions/sequence`}>`sequence()`</a>
