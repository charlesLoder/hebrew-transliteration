...
- transliteration — [`transliterate()`](/hebrew-transliteration/api/functions/transliterate)
- removing niqqud — [`remove()`](/hebrew-transliteration/api/functions/remove)
- sequencings text — [`sequence()`](/hebrew-transliteration/api/functions/sequence)
