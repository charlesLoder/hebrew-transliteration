...
test("non-Hebrew characters and multiple words", () => {
  expect(
    sequence(
      "word 1 \u{5D1}\u{5B0}\u{5BC}\u{5E8}\u{5B5}\u{5D0}\u{5E9}\u{5B4}\u{5C1}\u{596}\u{5D9}\u{5EA} word 2 \u{5DB}\u{5A3}\u{5B4}\u{5BC}\u{5D9}"
    )
  ).toBe(
    "word 1 \u{5D1}\u{5BC}\u{5B0}\u{5E8}\u{5B5}\u{5D0}\u{5E9}\u{5C1}\u{5B4}\u{596}\u{5D9}\u{5EA} word 2 \u{5DB}\u{5BC}\u{5B4}\u{5A3}\u{5D9}"
  );
});
